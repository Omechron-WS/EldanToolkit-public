...
using EldanToolkit.WildStar.TestBed.GameTable.IO;
...
namespace EldanToolkit.WildStar.TestBed.GameTable
{
					...
					foreach (var column in columnsOrdered)
					{
						switch (GetDataType(table.schema[column]))
						{
							...
							case DataType.String:
								...
								if (stringLookup.TryGetValue(cell, out uint position))
								{
								...
								else
								{
									...
									stringLookup.Add(cell, stringPosition);

									stringTableWriter.WriteWideString(cell);
								}
